 ...
 * 9 August 2016
 * Glycopter project
 * This class calculates all the dihedral angles in the molecule. This will then be used to
 * calculate the energy of the molecule associated with the dihedral angles. 
 */
package resources;
